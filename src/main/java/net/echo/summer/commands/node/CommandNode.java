...
import net.echo.summer.commands.Command;
import net.echo.summer.commands.CommandHandler;
import net.echo.summer.commands.bukkit.BukkitCommand;
import net.echo.summer.commands.help.HelpNode;
import net.echo.summer.commands.parameter.Param;
...
public class CommandNode {
    ...
    public static List<CommandNode> getNodes() {
        return CommandNode.nodes;
    }

    public static HashMap<Class<?>, Object> getInstances() {
        return CommandNode.instances;
    }
